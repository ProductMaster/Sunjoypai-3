		...
		<div class="container">
			<div>
				...
				<form id="validateForm" class="form-horizontal" method="post"
					action="${pageContext.request.contextPath }/weixin/article/addMArticleMsgMenu">
						...
						<tr class="th">
							...
							<tr class="th" id="nextview1">
								<th class="rth" >
									指定URL：</th>
								<td class="ltd" colspan="3">
									 <input class="input-xlarge required" name="url_m" type="text" value="/weixin/article/listArticle/"/>
								</td>
							</tr>
							<tr><th colspan="4"></th></tr>
							<tr class="th">
