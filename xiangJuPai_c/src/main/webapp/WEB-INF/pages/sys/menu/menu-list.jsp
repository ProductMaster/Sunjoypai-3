					...
					<table class="table table-bordered table-striped">
						<tbody>
							...
							<tr>
								...
								<td> 
									<c:if test="${menu.leaf}">
										<img style='filter:gray;' border='0' title='此节点为叶子节点' src='${pageContext.request.contextPath}/images/insert.gif'/>
									</c:if>
									<c:if test="${!menu.leaf}">
										<a href='${pageContext.request.contextPath}/menu/new/${menu.id}'>
											<img border='0' title='添 加' src='${pageContext.request.contextPath}/images/insert.gif'/>
										</a>
									</c:if>
								</td>
								<td class="td">
									<a href='${pageContext.request.contextPath}/menu/${menu.id}'>
										<img border='0' title='修 改' src='${pageContext.request.contextPath}/images/edit.gif'/>
									</a>					
								</td>
								<td class="td">
									<a href='${pageContext.request.contextPath}/menu/destroy/${menu.id}'>
										<img border='0' title='删 除' src='${pageContext.request.contextPath}/images/delete.gif'/>
									</a>
								</td>				
							</tr>	
							</ueye:forEach>
