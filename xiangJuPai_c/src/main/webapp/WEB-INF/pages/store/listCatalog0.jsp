...
<div class="attentionTop">
	<i class="m_back"></i>
	<ul>
		<li class="hover"><a href="${pageContext.request.contextPath}/store/listCatalog/0">已上架</a></li>
		<li><a href="${pageContext.request.contextPath}/store/listCatalog/1">已下架</a></li>
	</ul>
	...
	<ul>
		<c:forEach items="${catalogs}" var="catalog" varStatus="status">
			<li>
				...
				<span>
					￥${catalog.salePrice}
					<a href="${pageContext.request.contextPath}/store/updateCatalogStatus/${catalog.id}" class="contentbox-link2">下架</a>
