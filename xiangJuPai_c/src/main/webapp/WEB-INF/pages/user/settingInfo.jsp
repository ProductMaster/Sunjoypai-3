...
<form id="validateForm" class="form-horizontal" method="post" action="${pageContext.request.contextPath}/user/updateUserInfo/${userInfo.id}" >
	<div class="storeName">
		<ul>
			<li>
				<span>昵称：<input type="text" class="main" name="userName" id="userName" value = "${userInfo.userName}" /></span>
				<i class="iconfont" href="javascript:void(0)" onclick="return doClear('userName');">&#xe60c;</i>
			</li>
