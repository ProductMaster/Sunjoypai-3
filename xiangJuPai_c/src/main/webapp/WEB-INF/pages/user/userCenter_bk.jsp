...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body style="background:#fafafa;">
    ...
    <div class="sc_content">
               ...
               <div class="row">
                   <div class="col-xs-3">
	                 <c:if test="${userInfo.picUrl == null || userInfo.picUrl ==''}">
	                     <img class=" img-rounded" src="${userInfo.logo}" alt=""/>
                     </c:if>
                   ...
                   <div class="col-xs-9" style=" padding-left:0px;">
                      <span class="my_name">${userInfo.userName}</span>
                      <c:if test="${storeInfo.storeName != null}">
                      <span class="my_shop_name">店铺:${storeInfo.storeName}</span>
                      </c:if>
                   </div>
               </div>
             </a>
        ...
        <div class="my_bottom">
		        ...
		        <div class="my_list_con" style="background: #ffffff;">
		           <div class="container" style="padding-right:0px;">
		            <div class="my_list_1" style="border:none;">
		             <div class="container" style="padding-left:0px;">
		                 ...
		                 <div class="col-xs-12" id='qr'>
		                  <a href="${pageContext.request.contextPath}/user/getQRCode"><img src="${pageContext.request.contextPath}/images/gj-5.png" alt=""/>我的店铺二维码</a>
		                 </div>
		                </div>
		              </div>
		             </div>
		            ...
		            <div class="container" style="padding-right:0px;">
		             <div class="my_list_1">
			             <div class="container" style="padding-left:0px;">
			             	<a href="${pageContext.request.contextPath}/store/listCatalog">
			                <div class="row">
			                  	<div class="col-xs-12">
				                  <span><img src="${pageContext.request.contextPath}/images/gj-4.png" alt=""/>商品管理</span>
			                 	</div>
			                </div>
			                </a>
			              </div>
		             ...
		             <div class="container" style="padding-right:0px;">
			             <div class="my_list_1">
			             	<div class="container" style="padding-left:0px;">
			              		<a href="${pageContext.request.contextPath}/store/listCase">
			             		<div class="row">
					                 <div class="col-xs-12">
	             ...
	             <c:if test="${storeInfo.storeName != null}">
		             <div class="container">
		              <a href="${pageContext.request.contextPath}/store/storeDetail/${storeInfo.id}">
		             	<div class="row">
		                 <div class="col-xs-12">
	             ...
	             <div class="my_list" style="background: #ffffff;">
	             <div class="container">
	              <a href="${pageContext.request.contextPath}/store/storeInfo">
	             	<div class="row" >
	                 <div class="col-xs-12">
			...
			<c:if test="${currentUser.userType==0}">
				<div class="my_list" style="background: #ffffff;">
	             	<div class="container">
		              <a href="${pageContext.request.contextPath}/user/addStore">
		             	<div class="row">
		                 <div class="col-xs-12">
		                  <span><img src="${pageContext.request.contextPath}/images/gj-2.png" alt=""/>激活店铺</span>
		                 </div>
		                </div>
		              </a>
	              	</div>
	...
	<div class="foot">
        ...
        <span><a href="${pageContext.request.contextPath}/user/userCenter"><img src="${pageContext.request.contextPath}/images/foot-p4-2.png"/></a></span>
    </div> 
