...
<%-- 		<script src="${pageContext.request.contextPath}/js/utils/common/viewport.js" type="text/javascript" charset="utf-8"></script>
	...
	<body>
		<form id="validateForm" class="form-horizontal" method="post" action="${pageContext.request.contextPath}/user/updateUserInfo/${userInfo.id}" >
			<input type="text" class="main" name="userName" value= "${userInfo.userName}"/>
			<br/>
			<input type="radio" name="sex" value="1" ${userInfo.sex==1?'checked':''}/>男
			<input type="radio" name="sex" value="0" ${userInfo.sex==0?'checked':''} />女
			<label class="delete"><img src="${pageContext.request.contextPath}/images/delete.png" alt="" /></label>
			<a href="javascript:void(0)" onclick="return doSubmit();"><div class="saveBtn"><img src="${pageContext.request.contextPath}/images/saveBtn.png" alt="" /></div></a>
		</form>
