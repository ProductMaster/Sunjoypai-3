...
function getCmdyCount() {
    ...
    0 != a.length && utils.ajaxReq({
        url: window.basePath + "/plus/action/count/get?" + window.baseParam,
        dataType: "json",
        data: {
            t: +new Date
        }
...
var utils = {
    ...
    payDeal: function (a, b) {
        var c, d = a.data;
        d.payType ? location.href = window.basePath + "/cn/deal/codSuc.html?dc=" + d.dealCode + "&suin=" + d.sellerUin + "&" + window.baseParam : d.payChannel ? (c = window.basePath + "/cn/minipay/tcallback.html?paySuc=true&dealCode=" + d.dealCode + "&feeCash=" + d.minipayPo.feeCash + "&t=" + (new Date).getTime(), WeixinJSBridge.invoke("getBrandWCPayRequest", {
            ...
            sureFn: function () {
                WeixinJSBridge.invoke("addContact", {
                    ...
                    if ("add_contact:ok" == a.err_msg || "add_contact:added" == a.err_msg) {
                        ...
                        var c = new Image;
                        c.src = window.basePath + "/cn/focus/updateRelate.html", b()
                    }
                })
            }
        })
...
utils.namespace("mobile.o2ocn.addrList"), utils.namespace("mobile.o2ocn.addrchoose"), function () {
    ...
    a.init = function () {
        ...
        $("#forward").on("click", function () {
            var a, b = new localStore("order"),
				c = window.basePath + "/cn/my/index.html?" + window.baseParam;
        ...
        $("#toAdd").on("click", function () {
            return len >= 10 ? (utils.showConfirm({
                ...
                sureFn: function () {
                    return c.support() ? c.setValue(location.href, !1) : navigator.cookieEnabled && utils.setCookie("o2o_re_url", location.href), location.href = window.basePath + "/cn/recvaddr/list.html?" + window.baseParam, !1
                }
            }), !1) : !0
    ...
    address.init = function () {
        ...
        this.isUpdate = parseInt($("#isUpdate").val(), 10), this.provId = parseInt($("#provId").val(), 10), this.oprTip = parseInt($("#oprTip").val(), 10), this.provinceNode = $("#province"), this.cityNode = $("#city"), this.regionNode = $("#regionId"), this.allProvince =
            [{ "pname": "北京", "provinceId": 1 },
                { "pname": "天津", "provinceId": 2 },
                { "pname": "上海", "provinceId": 9 },
                { "pname": "重庆", "provinceId": 22 },
                { "pname": "广东", "provinceId": 19 },
                { "pname": "河北", "provinceId": 3 },
                { "pname": "山西", "provinceId": 4 },
                { "pname": "内蒙古", "provinceId": 5 },
                { "pname": "辽宁", "provinceId": 6 },
                { "pname": "吉林", "provinceId": 7 },
                { "pname": "黑龙江", "provinceId": 8 },
                { "pname": "江苏", "provinceId": 10 },
                { "pname": "浙江", "provinceId": 11 },
                { "pname": "安徽", "provinceId": 12 },
                { "pname": "福建", "provinceId": 13 },
                { "pname": "江西", "provinceId": 14 },
                { "pname": "山东", "provinceId": 15 },
                { "pname": "河南", "provinceId": 16 },
                { "pname": "湖北", "provinceId": 17 },
                { "pname": "湖南", "provinceId": 18 },
                { "pname": "广西", "provinceId": 20 },
                { "pname": "海南", "provinceId": 21 },
                { "pname": "四川", "provinceId": 23 },
                { "pname": "贵州", "provinceId": 24 },
                { "pname": "云南", "provinceId": 25 },
                { "pname": "西藏", "provinceId": 26 },
                { "pname": "陕西", "provinceId": 27 },
                { "pname": "甘肃", "provinceId": 28 },
                { "pname": "青海", "provinceId": 29 },
                { "pname": "宁夏", "provinceId": 30 },
                { "pname": "新疆", "provinceId": 31 },
                { "pname": "台湾", "provinceId": 32 },
                { "pname": "香港", "provinceId": 33 },
                { "pname": "澳门", "provinceId": 34 }];
        var a = this;
        ...
        }), a.isUpdate > 0 || 6 == a.oprTip ? ("1" == a.provId || "2" == a.provId || "9" == a.provId || "21" == a.provId) && a.cityNode.parent().addClass("qb_none") : (a.cityNode.parent().addClass("qb_none"), a.regionNode.parent().addClass("qb_none"))
        ...
        $("#province").on("change", function () {
            ...
            utils.ajaxReq(e, function (f) {
                f.errCode || (a.setSelArea(a.cityNode, "选择市", f.data), a.regionNode.parent().addClass("qb_none"), ("1" == b || "2" == b || "9" == b || "22" == b) && (c = $("#scity").attr("data-url"), d.ctid = f.data[0].id, a.cityNode.val(d.ctid), e.url = c, e.data = d, utils.ajaxReq(e, function (b) {
        ...
        this.check() && document.forms['ctl00'].submit();;
...
}(), utils.namespace("mobile.o2ocn.userinfo"), function () {
    function validate(rule) {
        function showError(a, b) {
            var c = $("#" + b + "_msg");
            c.removeClass("qb_none").html(a), errArr.push(b)
    ...
    var userinfo = mobile.o2ocn.userinfo;
    userinfo.init = function () {
        ...
        switch (window.oTip) {
            case 1:
                ...
                break;
            case 2:
                a.addClass("mod_tip_warn").removeClass("qb_none").html("用户名已存在！");
                break;
            case 3:
                a.addClass("mod_tip_warn").removeClass("qb_none").html("修改失败，请稍后重试！");
                break;
    ...
    }, userinfo.bindEvent = function () {
        var a = this;
        $("#save_user_info").on("click", function () {
            return a.save(), !1
        })
    }, userinfo.save = function () {
        this.check() && document.getElementById("ctl00").submit();;
    }, userinfo.check = function () {
        return utils.validate(this.formRule);
    }
    ...
    g.init = function () {
        ...
        if (!a.hasClass("btn_disabled")) {
            ...
            if ("0" === d && b.pc < 0) return utils.showBubble("请选择支付方式"), void 0;
            $.each(window.subParam, function (a, b) {
                e.push(b.ic + "-" + b.attr + "-" + b.bc + "-" + b.mid)
            }), a.addClass("btn_disabled"), utils.ajaxReq({
                url: window.basePath + "/plus/action/order/make?" + window.baseParam,
                dataType: "json",
                type: "POST",
                data: {
                    orderStrList: e.toString(),
                    adid: c.adid,
                    payType: d,
                    pc: b.pc,
                    mtype: b.curMtype,
                ...
                b.errCode ? 3 == b.errCode ? (a.removeClass("btn_disabled"), utils.showBubble("支付配置 出错!")) : (a.removeClass("btn_disabled"), utils.showAjaxErr(b, "下单失败，请重试")) : utils.payDeal(b, a)
            })
        }
    ...
    a.init = function () {
        ...
        a.itemList.each(function () {
            ...
            f > 0 && g > f && (a.modifyNum(b, f), utils.showBubble("您填写的购买数量已超过上限")), b.find(".count").on("input", function () {
                ...
                window.location = window.basePath + "/cn/item/detail.html?ic=" + d + "&" + window.baseParam
            })
        })
        ...
        utils.ajaxReq({
            type: "POST",
            url: window.basePath + "/plus/action/cart/modifyNum?" + window.baseParam,
            data: {
                ic: d.attr("ic"),
                attr: d.attr("sa"),
                mid: d.attr("mid"),
        ...
        utils.ajaxReq({
            type: "POST",
            url: window.basePath + "/plus/action/cart/remove?" + window.baseParam,
            data: i,
            dataType: "json"
        }, function (d) {
        ...
        for (var e in b.selectItems.items) c.push(b.itemCache[e].mid);
    ...
    a.init = function () {
        ...
        switch (window.dealStatus) {
            ...
            case 22:
                ...
                (a.push('<div class="qb_flex qb_mb10 ui_gap">'), a.push($("#recv-tpl").html()), a.push("</div>"));
                break;
            case 30:
                //3 == window.payType ? $("#suc-msg").removeClass("qb_none") : (a.push('<div class="qb_flex qb_mb10 ui_gap">'), a.push($("#recv-tpl").html()), a.push("</div>"));
                $("#suc-msg").removeClass("qb_none");
                break;
            case 7:
        ...
        utils.showConfirm({
            cancelFn: function () {
                utils.ajaxReq({
                    url: window.basePath + "/cn/deal/applyRefund.html",
                    data: {
                        dc: window.dc,
                        t: +new Date
                    },
                    ...
                    a.errCode ? 260 == a.errCode ? utils.showBubble("登录校验失败") : utils.showAjaxErr(a, "申请退款遇到错误，请重试") : utils.showConfirm({
                        ...
                        showNum: 1,
                        sureFn: function () {
                            location.href = window.basePath + "/cn/my/index.html?dback=true&index=2"
                        }
                    })
                }, function () {
        ...
        utils.showConfirm({
            ...
            cancelText: "取消",
            sureFn: function () {
                location.href = window.basePath + "/cn/refund/applyIndex.html?dc=" + window.dc + "&" + window.baseParam
            }
        })
        ...
        utils.showConfirm({
            ...
            sureFn: function () {
                utils.ajaxReq({
                    url: window.basePath + "/cn/refund/bcancel.html",
                    dataType: "json",
                    data: {
                        dc: window.dc
                    }
        ...
        return "true" === stockEmpty ? (utils.showBubble("商品库存不足"), void 0) : (0 == a.value ?
        utils.ajaxReq({
            url: window.basePath + "/plus/action/pay/to?" + window.baseParam,
            data: {
                order_id: a.getAttribute("dc"),
                pc: a.item(a.selectedIndex).getAttribute("pid"),
                t: +new Date
            },
            dataType: "json"
        }, function (c) {
            c.errCode ? 260 == c.errCode ? utils.showBubble("登录超时") : utils.showAjaxErr(c, "请求遇到错误，请重试。") : location.href = c.data.payUrl
        }, function () {
            utils.showBubble("请求遇到了点问题，请重试。")
        }) : 1 == a.value && utils.payDeal({
            data: {
    ...
    g.init = function () {
        ...
        if (!c.hasClass("btn_disabled")) {
            ...
            if (b.pc < 0 && 1 != b.curPtype) return utils.showBubble("请选择支付方式"), !1;
            d.mt = b.curMtype, d.pt = b.curPtype, d.adid = e.adid, d.promId = b.promoteId ? b.promoteId : 0, d.pc = b.pc, d.comeFrom = e.comeFrom, d.t = +new Date, d.couponId = b.couponId ? b.couponId : 0, utils.showBubble("正在提交订单数据..."), c.addClass("btn_disabled"), utils.ajaxReq({
                url: window.basePath + "/plus/action/order/make?t=" + Math.random() + "&" + window.baseParam,
                dataType: "json",
                type: "POST",
                data: d
            }, function (a) {
    ...
    a.init = function () {
        ...
        if (window.lz) {
            ...
            f.length > 0 && (a = window.innerWidth, $.each(f, function (f, g) {
                g = $(g), tag = g.attr("tag"), "indexad" == tag ? (c = window.innerHeight - 1, e = a, g.width(a), g.height(c)) : $.os.ios || $.os.android ? "discount" == tag ? (e = a - 100, c = 160, g.width(e)) : (e = parseInt(a / 2, 10), c = 160, g.width(e)) : (e = 162, c = 160, g.width(e));
                var h = g.find("img"),
					i = h.attr("lazy");
                b(i, function (a, b) {
    ...
    a.init = function () {
        ...
        }), $("#viewPic").on("click", $.proxy(this.viewPic, this), $("#detail-slider li").on("click", $.proxy(this.viewBigPic, this)))
    }, a.viewBigPic = function (a) {
        var b = parseInt($(a.target).attr("index")),
            c = window.picLinks.substring(1, window.picLinks.length - 1).split(",");
        ...
        if (this.buyNode.hasClass("btn_strong")) {
            ...
            $("#attr").val(encodeURIComponent(this.buyProperty)), $("#mid").val(window.availSku[this.buyProperty].pid), $("#bc").val(this.buyNum), document.detailForm.submit()
        }
    }, a.addCart = function () {
        if (window.totalStock > 0 && window.sku.length > 0 && !this.buyProperty) return utils.showBubble(this.errorMsg), void 0;
        var a = this,
			b = {
			    ...
			    mid: window.availSku[this.buyProperty].pid,
			    bc: this.buyNum,
			    t: (new Date).getTime()
			};
        utils.ajaxReq({
            url: window.basePath + "/plus/action/cart/add?" + window.baseParam,
            dataType: "json",
            type: "POST",
            data: b
        }, function (b) {
            b.errCode ? utils.showConfirm({
                ...
                cancelText: "再逛逛",
                sureFn: function () {
                    location.href = window.basePath + "/cart.html?" + window.baseParam
                }
            })
        })
    }, a.handleOpen = function () {
        this.infoNode.parent().toggleClass("fold");
        this.infoNode.parent().children(":first-child").toggleClass("maxheight");
        ...
        if (c.selectedCount == window.sku.length) {
            ...
            c.buyProperty = d, a = window.availSku[d], a && ($("#buyNum").val(1), b = a.stockCount, (a.stockCount == "0") ? ($("#J_buydisable").show(),$("#J_buy").hide()) : ($("#J_buydisable").hide(),$("#J_buy").show()), (a.stockCount == "") ? ($("#stock-num-prev").html("不"), $("#stock-num-next").html("限"), $("#stock-num").html("99").hide()) : ($("#stock-num-prev").html("剩余"), $("#stock-num-next").html("件"), $("#stock-num").html(b).show()), c.curStock = (a.stockCount == "") ? 9999 : parseInt(b, 10), $("#price").html("&yen;" + (a.stockPrice / 100).toFixed(2)), $("#maketPrice").html("&yen;" + (a.maketPrice / 100).toFixed(2)))
        }
    }, a.handleInput = function (a) {
        var b = $(a.target),
			c = b.val(),
            bmn = parseInt(window.buymaxnum);
        c && isNaN(c) ? (b.val(1), utils.showBubble("购买数量只能输入数字，已自动修改")) : c && 0 >= c ? (b.val(1), utils.showBubble("至少购买一件")) : /\d+\.\d*/.test(c) ? (b.val(parseInt(c, 10)), utils.showBubble("购买数量只能输入整数")) : c > bmn ? this.curStock > bmn ? (utils.showBubble("单次购买数量不可超过" + bmn + "件，已自动修改"), b.val(bmn), this.buyNum = bmn) : (utils.showBubble("购买数量超过库存限制，已自动修改"), b.val(this.curStock), this.buyNum = this.curStock) : c > this.curStock ? (utils.showBubble("购买数量超过库存限制，已自动修改"), b.val(this.curStock), this.buyNum = this.curStock) : this.buyNum = c
        ...
        if (e) {
            if (isNaN(e)) d.val(1);
                ...
                if ("add" == c) {
                    if (this.curStock > bmn && e >= bmn) return utils.showBubble("单次购买数量不可超过"+bmn+"件"), void 0;
        ...
        function c() {
            ...
            if (g = g ? JSON.parse(g) : "", a = g ? g[h] : "", a && (b = a.time, 1728e5 >= i - b ? c = a.imgList : (delete g[h], e.setValue(g, !0))), c) d(c);
                ...
                utils.ajaxReq({
                    url: window.basePath + "/cn/item/moreImg.html",
                    dataType: "json",
                    data: {
                        ic: h
                    }
    ...
    a.init = function () {
        ...
        for (var b, c, d, e, f, g, h = [], i = 0, j = a.length; j > i; i++) {
            ...
            for (var k = 0, l = c.length; l > k; k++) {
                g = c[k];
                d.push(utils.strReplace(this.itemListTpl, {
                    pic: g.pic,
                    singleShow: 1 == l ? "" : "qb_none",
                    itemName: g.name,
                    attr: g.mid ? '<p class="qb_fs_s ui_color_weak">商品编号：' + g.sn + "</p>" : "",
        ...
        a.curTabPageNum++, a.loadNode.html("加载中..."), utils.ajaxReq({
            url: window.basePath + "/cn/my/next.html?" + window.baseParam,
            dataType: "json",
            data: {
        ...
        var c = {
            0: window.basePath + "/plus/action/pay/to?" + window.baseParam,
            1: window.basePath + "/cn/minipay/generateMinipay.html?" + window.baseParam
        };
        c[b] && utils.ajaxReq({
            url: c[b],
            data: {
        ...
        utils.ajaxReq({
            url: a.getAttribute("url") + "?" + window.baseParam,
            data: { order_id: a.getAttribute("dc") },
            dataType: "json"
        }, function (b) {
        ...
        var b = parseInt(a.value, 10); -1 != b && (utils.showBubble(0 == b ? "正在前往支付中心，请稍后" : "正在调用微信支付"), this.toPay(a, b))
    }
}();// windows phone手机，因为无法正常展示页面，则提示用户
if (/Windows Phone|NOKIA|Nokia/.test(navigator.userAgent)) {
    alert("友情提醒：当前您使用的操作系统或版本可能会导致浏览的部分页面样式错乱，采用ios或android系统可获得更佳的体验，谢谢！");
...
utils.namespace("mobile.o2ocn.addrList"), utils.namespace("mobile.o2ocn.addrchoose"), function () {
    ...
    address.init = function () {
        this.formRule = {
            ...
            mobile: {
                emptyMsg: "请填写收件人的联系电话",
                itemName: "收件人联系电话",
                reg: /(^(204|250|289|306|403|416|418|450|506|514|519|604|613|647|705|709|778|780|807|819|867|902|905)\d{7})|((021|022|025|026|027)\d{5,7}$)|(^09\d{8}$)|(^0\d{9}$)|(^13\d{9}$)|(^15[012356789]\d{8}$)|(^18[012356789]\d{8}$)|(^14[57]\d{8}$)/,
                //reg: /((\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$)/,
                errMsg: "请填写正确的联系电话",
                required: !0,
                minLen: 5
        ...
        this.isUpdate = parseInt($("#isUpdate").val(), 10), this.provId = parseInt($("#provId").val(), 10), this.oprTip = parseInt($("#oprTip").val(), 10), this.provinceNode = $("#province"), this.cityNode = $("#city"), this.regionNode = $("#regionId"), this.allProvince =
            [{ "pname": "北京", "provinceId": 1 },
                ...
                { "pname": "香港", "provinceId": 33 },
                { "pname": "澳门", "provinceId": 34 },
                { "pname": "海外", "provinceId": 35 }];
        var a = this;
        $.each(a.allProvince, function (b, c) {
            c.provinceId == a.provId ? a.provinceNode.append("<option value='" + c.provinceId + "' selected='selected'>" + c.pname + "</option>") : a.provinceNode.append("<option value='" + c.provinceId + "'>" + c.pname + "</option>")
        }), a.isUpdate > 0 || 6 == a.oprTip ? ("1" == a.provId || "2" == a.provId || "9" == a.provId || "21" == a.provId || "35" == a.provId) && a.cityNode.parent().addClass("qb_none") : (a.cityNode.parent().addClass("qb_none"), a.regionNode.parent().addClass("qb_none"))
    }, address.bindEvent = function () {
        var a = this;
        $("#province").on("change", function () {
            var b = a.provinceNode.val(),
            ...
            utils.ajaxReq(e, function (f) {
                f.errCode || (a.setSelArea(a.cityNode, "选择市", f.data), a.regionNode.parent().addClass("qb_none"), ("1" == b || "2" == b || "9" == b || "22" == b || "35" == b) && (c = $("#scity").attr("data-url"), d.ctid = f.data[0].id, a.cityNode.val(d.ctid), e.url = c, e.data = d, utils.ajaxReq(e, function (b) {
                    b.errCode || (a.setSelArea(a.regionNode, "选择区", b.data), a.cityNode.parent().addClass("qb_none"))
                })))
            })
        }), $("#city").on("change", function () {
    ...
    g.init = function () {
        ...
        b.totalPrice = parseInt(b.totalPrice, 10), a.evtConfig = {
            click: {
                submitOrder: a.handleSure,
                toAddrList: a.handleToAddr,
                singleChoiceChange: a.handlesingleChange,
                choicetype1: a.handletype1change,
                choicetype2: a.handletype2change,
                choicetype3: a.handletype3change,
                choicetype4: a.handletype4change,
                couponChoiceChange: a.handlecouponChange
            },
            change: {
                changePay: a.changePay,
                sendType: a.handleFeeChange,
            ...
            input: {
                yueinput: a.handleyueInput,
                memoinput: a.handlememoInput
            }
        }, a.priceNode = $("#total-price"), a.realPriceNode = $("#real-price"), a.pkgShipFeeNode = $("#select_shipFee"), a.pkgLen = parseInt(b.pkgLen, 10), a.curMtype = "", a.curShipFee = "", a.isFreeFee = !1, a.reduce = 0, a.couponReduce = 0, a.promoteId = 0, a.couponId = null, a.useCoupon = !0, a.payPrice = 0, a.realPrice = 0, a.pc = "true" === b.minipay ? -1 : 0, a.scdval = "", a.singleCheckedNode = $("input[name='singleChoice']:checked"), a.multiCheckedNode = $("input[name='multiChoice']:checked"), a.usevip = false, a.usetype1 = false, a.usetype2 = false, a.usetype3 = false, a.usetype4 = false, a.typevalue1, a.typevalue2, a.typevalue3, a.typevalue4, a.djqmz, a.djqje, a.djqmc, a.memoNode = $("#memo"), a.memo = "", a.promoteIndex = {
            0: {
                op: "-",
                num: b.totalPrice
            },
        ...
        document.body.addEventListener("change", this, !1), document.querySelector(".lay_page").addEventListener("click", this, !1), document.querySelector(".lay_page").addEventListener("input", this, !1)
    }, g.handleEvent = function (a) {
        var b = a.type,
			c = a.target,
			d = c.getAttribute("evtTag");
        ...
        var sp = a;
        //进行判断
        if (b.singleCheckedNode) {
            if (b.usetype1) {
                sp = sp * parseFloat(b.typevalue1 / 100);
            }
            if (b.usetype2 && b.typevalue2) {
                if (b.djqmz && b.djqmz > 0) {
                    if (sp < parseInt(b.djqmz) * 100) {
                        utils.showBubble("必须满足优惠券的面值才可以使用!");
                    }
                    else {
                        sp = sp - parseInt(b.djqje) * 100;
                    }
                }
            }
            if (b.usetype3 && b.typevalue3) {
                if (b.typevalue3 > sp) {
                    utils.showBubble("积分优惠金额大于总价格");
                }
                else {
                    sp = sp - parseFloat(b.typevalue3 * 100);
                }
            }
            if (b.usetype4 && b.typevalue4) {
                if (b.typevalue4 > sp) {
                    utils.showBubble("使用金额大于总价格");
                }
                else {
                    sp = sp - parseFloat(b.typevalue4 * 100);
                }
            }
        }
        b.realPrice = sp, b.realPriceNode.html("&yen;" + (sp / 100).toFixed(2)), b.payPrice = a, b.priceNode.html("&yen;" + (a / 100).toFixed(2)), b.reduce + b.couponReduce < 0 ? ($("#dealoff-div").removeClass("qb_none"), $("#dealoff-price").html("&yen;" + ((-1 * b.reduce + -1 * b.couponReduce) / 100).toFixed(2))) : $("#dealoff-div").addClass("qb_none")
    }, g.divPrice = function (a) {
        var b = {
            price: (a / 100).toFixed(2),
            free: "0.00",
        ...
        if (!a.hasClass("btn_disabled")) {
            ...
            if (b.singleCheckedNode) {
                if (b.usetype2) {
                    if (!b.typevalue2) {
                        return utils.showBubble("请选择可用的代金券!"), void 0;
                    }
                    else {
                        if (b.realPrice && b.realPrice + parseInt(b.djqje) * 100 < parseInt(b.djqmz) * 100) {
                            return utils.showBubble("必须满足优惠券的面值才可以使用!"), void 0;
                        }
                    }
                }
                if (b.usetype4) {
                    if (!b.typevalue4) {
                        //使用余额
                        return utils.showBubble("请填写使用正确的余额!"), void 0;
                    }
                    else {
                        if (b.realPrice && b.realPrice < 0) {
                            return utils.showBubble("余额不能大于实付金额!"), void 0;
                        }
                    }
                }
            }
            if (b.realPrice && b.realPrice < 0) {
                return utils.showBubble("实付金额不正确!"), void 0;
            }
            if (b.realPrice && b.realPrice > 0) {
                if ("0" === d && b.pc < 0) return utils.showBubble("请选择支付方式"), void 0;
            }
            $.each(window.subParam, function (a, b) {
                ...
                data: {
                    ...
                    ship_area_store: c.ship_area_store,
                    ship_mobile: c.ship_mobile,
                    ship_name: c.ship_name,
                    usevip: b.usevip,//使用会员
                    usetype1: b.usetype1,
                    usetype2: b.usetype2,
                    usetype3: b.usetype3,
                    usetype4: b.usetype4,
                    typevalue1: b.typevalue1,
                    typevalue2: b.typevalue2,
                    typevalue3: b.typevalue3,
                    typevalue4: b.typevalue4,
                    djqmz: b.djqmz,
                    djqje: b.djqje,
                    djqmc: b.djqmc,
                    memo: b.memo,
                ...
                if (b.errCode) {
                    if (3 == b.errCode) {
                        a.removeClass("btn_disabled");
                        utils.showBubble("支付配置 出错!");
                    }
                    else if (b.errCode > 4) {
                        a.removeClass("btn_disabled");
                        utils.showBubble(b.errMsg);
                    }
                    else {
                        a.removeClass("btn_disabled");
                        utils.showBubble(b.errMsg);
                        //utils.showAjaxErr(b, "下单失败，请重试");
                    }
                } else {
                    utils.payDeal(b, a);
                }
    ...
    }, g.handlesingleChange = function (a) {
        //单一使用优惠信息
        var b = this;
        if (b.singleCheckedNode) {
            var singleType = $(a).val();
            //使用会员
            this.usevip = true;
            var singleList = $("input[name='singleChoice']");
            for (var i = 0; i < singleList.length; i++) {
                if (!$(singleList[i]).is(":checked")) {
                    if ($(singleList[i]).val() == 1) {
                        this.usetype1 = false;
                    }
                    if ($(singleList[i]).val() == 2) {
                        this.usetype2 = false;
                        this.typevalue2 = false;
                    }
                    if ($(singleList[i]).val() == 3) {
                        this.usetype3 = false;
                    }
                    if ($(singleList[i]).val() == 4) {
                        this.usetype4 = false;
                        this.typevalue4 = false;
                    }
                }
            }
            if (singleType == 1) {
                this.usetype1 = true;
                this.typevalue1 = $(a).closest("dl").find("input[name='singleChoiceValue']").val();
                a && b.countPrice();
                //utils.showBubble(this.typevalue1);
            }
            else if (singleType == 2) {
                this.usetype2 = true;
                //$(a).closest("dl").find("input[name='singleChoiceValue']").prop('checked', false);
            }
            else if (singleType == 3) {
                this.usetype3 = true;
                this.typevalue3 = $(a).closest("dl").find("input[name='singleChoiceValue']").val();
                a && b.countPrice()
                //utils.showBubble(this.typevalue3);
            }
    ...
    }, g.handletype1change = function (a) {
        var b = this;
        if ($(a).is(":checked")) {
            this.usevip = true;
            this.usetype1 = true;
            this.typevalue1 = $(a).closest("dl").find("input[name='multiChoiceValue']").val();
            //utils.showBubble(this.typevalue1);
        } else {
            this.usetype1 = false;
            a && b.countPrice();
            if (!b.multiCheckedNode) {
                this.usevip = b.usevip || false;
            }
        }
        a && b.countPrice();
    }, g.handletype2change = function (a) {
        var b = this;
        if ($(a).is(":checked")) {
            this.usevip = true;
            this.usetype2 = true;
            ...
            this.usetype2 = false;
            this.typevalue2 = false;
            $(a).closest("dl").find("input[name='multiChoiceValue']").prop('checked', false);
            if (!b.multiCheckedNode) {
                this.usevip = b.usevip || false;
            }
        }
        a && b.countPrice();
    }, g.handletype3change = function (a) {
        var b = this;
        if ($(a).is(":checked")) {
            this.usevip = true;
            this.usetype3 = true;
            this.typevalue3 = $(a).closest("dl").find("input[name='multiChoiceValue']").val();
            a && b.countPrice();
            //utils.showBubble(this.typevalue3);
        } else {
            this.usetype3 = false;
        ...
        a && b.countPrice();
    }, g.handletype4change = function (a) {
        var b = this;
        if ($(a).is(":checked")) {
            this.usevip = true;
            this.usetype4 = true;
        ...
        a && b.countPrice();
    }, g.handlecouponChange = function (a) {
        //使用单一代金券
        var b = this;
        //使用代金券
        this.typevalue2 = $(a).val();
        this.djqmz = $(a).next().val();
        this.djqje = $(a).next().next().val();
        this.djqmc = $(a).next().next().next().val();
        a && b.countPrice()
        //utils.showBubble(this.typevalue2);
    }, g.handleyueInput = function (a) {
        //使用余额
        var b = this;
        if ($(a).closest("dl").find("input[name='singleChoiceValue']").length > 0) {
            var curValue = $(a).closest("dl").find("input[name='singleChoiceValue']").val();
            var maxValue = $(a).closest("dl").find("input[name='singleChoiceValue']").attr("maxvalue");
            if (parseFloat(curValue) > parseFloat(maxValue)) {
                utils.showBubble("当前仅剩余额是:" + maxValue);
            }
            else {
                this.typevalue4 = curValue;
                if (b.singleCheckedNode && b.usetype4) {
                    b.countPrice();
                }
                //utils.showBubble(this.typevalue4);
            }
        }
        if ($(a).closest("dl").find("input[name='multiChoiceValue']").length > 0) {
            var curValue = $(a).closest("dl").find("input[name='multiChoiceValue']").val();
            var maxValue = $(a).closest("dl").find("input[name='multiChoiceValue']").attr("maxvalue");
            if (parseFloat(curValue) > parseFloat(maxValue)) {
                utils.showBubble("当前仅剩余额是:" + maxValue);
            }
            else {
    ...
    }, a.handlewuliu = function () {
        location.href = $("#gowuliu").attr("addr");
    }, a.cancelReGoods = function () {
        utils.showConfirm({
            describeText: "您确定要取消退货吗？为确保您的权益，取消退货后，如有其它问题，请与我们联系。",
            sureFn: function () {
    ...
    a.init = function () {
        ...
        for (var b, c, d, e, f, g, h = [], i = 0, j = a.length; j > i; i++) {
            ...
            b.sdc = f.substr(0, f.length - 1), b.receive_show = 62 == b.ds && 1 == b.pt ? "" : "qb_none", b.waitpay_show = 23 == b.sc ? "" : "qb_none", b.pay_show = 60 == b.ds ? "" : "qb_none", b.itemPicList = d.join(""), b.totalCount = e, b.stateName = this.statusMap[b.sc], b.totalPay = (b.dt / 100).toFixed(2), b.show = 61 == b.ds || 71 == b.ds ? "" : "qb_none", h.push(utils.strReplace(this.containerTpl, b)), d = null
        }
        return h
    }, a.handleTabChange = function (a) {
        for (var b, c = a.target;
    ...
    }, a.deleteorder = function (a) {
        utils.ajaxReq({
            url: window.basePath + a.getAttribute("url"),
            data: { id: a.getAttribute("dc") },
            dataType: "json",
            type: "POST"
        }, function (b) {
            b.errCode ? 260 == b.errCode ? utils.showBubble("登录超时") : utils.showAjaxErr(b, "删除失败，请重试。") : (utils.showBubble("删除订单成功"), $(a).closest("div.mod_cell").addClass("qb_none"))
        }, function () {
            utils.showBubble("请求遇到了点问题，请重试。")
        })
    }, a.confirmReceive = function (a) {
