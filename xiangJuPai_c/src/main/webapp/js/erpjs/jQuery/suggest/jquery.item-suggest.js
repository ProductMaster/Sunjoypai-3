...
(function($) {
	$.suggest = function(input, options) {
		...
		if ($.browser.mozilla)
			t.$input.keyup(function(e) { t.processKey(e); });	// onkeypress repeats arrow keys in Mozilla/Opera
		else
			t.$input.keyup(function(e) { t.processKey(e); });	// onkeydown repeats arrow keys in IE/Safari
