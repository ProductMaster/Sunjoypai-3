...
(function($){$.extend({progressBar:new function(){this.defaults={increment:2,speed:15,showText:true,width:120,boxImage:'/js/jQuery/progressbar/images/progressbar.gif',barImage:{0:'/js/jQuery/progressbar/images/progressbg_red.gif',30:'/js/jQuery/progressbar/images/progressbg_orange.gif',70:'/js/jQuery/progressbar/images/progressbg_green.gif'},height:12};this.construct=function(arg1,arg2){var argpercentage=null;var argconfig=null;if(arg1!=null){if(!isNaN(arg1)){argpercentage=arg1;if(arg2!=null){argconfig=arg2;}}else{argconfig=arg1;}}
