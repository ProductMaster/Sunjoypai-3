var eBoxMinFlag = false;
var eBoxOpenFlag = false;
(function($){
   $.extend({
      eBox:function(option){
        var defaults={
	        size:{width:300,height:150,padding:0,borderWidth:"1px"},
		    title:{show:true,html:"标题"},
		    content:{url:false,html:"内容"},
		    skin:"/js/jQuery/pop/eBox.css",
		    imgUrl:"/js/jQuery/pop/images/",
			minButton:true,
			openOnce:true,
