...
//					edit             : true,  						      // 是否可以编辑文件（裁剪）
			...
			this.createHtml = function(){
				...
				if(para.dragDrop){
	            	...
	            	html += '						<input id="fileImage" type="file" size="30" name="uploadFile" '+multiple+'>';
	            	html += '					</div>';
	            	html += '				</div>';
		            ...
		            html += '				<div >';
		            html += '					<input id="fileImage" type="file" size="20" name="uploadFile" '+multiple+'>';
		           
		            html += '				</div>';
		            html += '			</div>';
		            html += '			<div id="preview" class="upload_preview">';
				    html += '				<div class="add_upload">';
				    html += '					<a style="height:25px;width:25px;" title="点击添加文件" id="rapidAddImg" class="add_imgBox" href="javascript:void(0)">';
				    html += '						<div class="uploadImg" style="width:50px">';
				    html += '							<img class="upload_image" src="zyupload/skins/images/add_img.png" style="width:50" />';
				    html += '						</div>'; 
				    html += '					</a>';
				    html += '				</div>';
					html += '			</div>';
			...
			this.funDisposePreviewHtml = function(file, e){
				...
				if (file.type.indexOf("image") == 0) {
					...
					html += '		</div>';
					html += '	</div>';
					html += '	<a style="height:55;width:50;" href="#" class="imgBox">';
					html += '		<div class="uploadImg" style="width:55px;max-width:50px;max-height:'+imgHeight+'px;">';				
